...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'f384e35010614000a92b41ea111e8725',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'DZS', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'AI 工程师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://www.dzs.life/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客,AI,LLMs,Stable Diffusion,', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '1980694906@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  COMMENT_UTTERRANCES_REPO:
        process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'blackDZS/dzs.life', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '48e5fa8c21704053b9ca38c9826fb688', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ANALYTICS_CNZZ_ID: process.env.NEXT_PUBLIC_ANALYTICS_CNZZ_ID || '', // 只需要填写站长统计的id, [cnzz_id] -> https://s9.cnzz.com/z_stat.php?id=[cnzz_id]&web_id=[cnzz_id]
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-N5CNDJWN6K', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
